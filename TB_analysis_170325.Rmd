...
### format date
raw$date.N0 <- ymd(raw$date.N0)
raw$date.N14 <- ymd(raw$date.N14)
raw$date.T01 <- ymd(raw$date.T01)
raw$date.T02 <- ymd(raw$date.T02)
raw$date.T03 <- ymd(raw$date.T03)
raw$date.T04 <- ymd(raw$date.T04)
raw$date.T05 <- ymd(raw$date.T05)
raw$date.T06 <- ymd(raw$date.T06)
raw$date.T07 <- ymd(raw$date.T07)
raw$date.T08 <- ymd(raw$date.T08)
raw$date.T09 <- ymd(raw$date.T09)
raw$date.T10 <- ymd(raw$date.T10)
raw$date.T11 <- ymd(raw$date.T11)
raw$date.T12 <- ymd(raw$date.T12)
raw$date.T13 <- ymd(raw$date.T13)
raw$date.T14 <- ymd(raw$date.T14)
raw$date.T15 <- ymd(raw$date.T15)
raw$date.T16 <- ymd(raw$date.T16)
raw$date.T17 <- ymd(raw$date.T17)
raw$date.T18 <- ymd(raw$date.T18)
raw$date.T19 <- ymd(raw$date.T19)
raw$date.T20 <- ymd(raw$date.T20)
raw$date.T21 <- ymd(raw$date.T21)
raw$date.T22 <- ymd(raw$date.T22)
raw$date.T23 <- ymd(raw$date.T23)
raw$date.T24 <- ymd(raw$date.T24)

raw$DateComplete <- ymd(raw$DateComplete)
raw$DateLastASS <- ymd(raw$DateLastASS)
raw$DateLastALIVE <- ymd(raw$DateLastALIVE)
raw$DateDeath <- ymd(raw$DateDeath)
raw$DateLastFU <- ymd(raw$DateLastFU)
raw$EnrolledDAT <- ymd(raw$EnrolledDAT)
```
